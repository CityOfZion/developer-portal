                        ...
                        <div className="card">
                            ...
                            <div className="card-block">
                                <form action="" method="post" encType="multipart/form-data" className="form-horizontal">
                                    ...
                                    <div className="form-group row">
                                        <label className="col-md-3 form-control-label" htmlFor="text-input">Text
                                            Input</label>
                                        <div className="col-md-9">
                                    ...
                                    <div className="form-group row">
                                        <label className="col-md-3 form-control-label" htmlFor="email-input">Email
                                            Input</label>
                                        <div className="col-md-9">
                                    ...
                                    <div className="form-group row">
                                        <label className="col-md-3 form-control-label" htmlFor="disabled-input">Disabled
                                            Input</label>
                                        <div className="col-md-9">
                                            <input type="text" id="disabled-input" name="disabled-input"
                                                   className="form-control" placeholder="Disabled" disabled/>
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        <label className="col-md-3 form-control-label"
                                               htmlFor="textarea-input">Textarea</label>
                                        <div className="col-md-9">
                                    ...
                                    <div className="form-group row">
                                        <label className="col-md-3 form-control-label" htmlFor="select">Disabled
                                            Select</label>
                                        <div className="col-md-9">
                                    ...
                                    <div className="form-group row">
                                        <label className="col-md-3 form-control-label" htmlFor="multiple-select">Multiple
                                            select</label>
                                        <div className="col-md-9">
                                    ...
                                    <div className="form-group row">
                                        <label className="col-md-3 form-control-label" htmlFor="file-input">File
                                            input</label>
                                        <div className="col-md-9">
                                    ...
                                    <div className="form-group row">
                                        <label className="col-md-3 form-control-label" htmlFor="file-multiple-input">Multiple
                                            File input</label>
                                        <div className="col-md-9">
                            ...
                            <div className="card-footer">
                                <button type="submit" className="btn btn-sm btn-primary"><i
                                    className="fa fa-dot-circle-o"></i> Submit
                                </button>
                                <button type="reset" className="btn btn-sm btn-danger"><i
                    ...
                    <div className="col-md-6">
                            ...
                            <div className="card-block">
                                <form action="" method="post" className="form-horizontal">
                                    <div className="form-group row">
                                        ...
                                        <div className="col-md-9">
                                            <input type="email" id="hf-email" name="hf-email" className="form-control"
                                    ...
                                    <div className="form-group row">
                                        <label className="col-md-3 form-control-label"
                                               htmlFor="hf-password">Password</label>
                                        <div className="col-md-9">
                        ...
                        <div className="card">
                            ...
                            <div className="card-block">
                                <form action="" method="post" className="form-horizontal">
                                    <div className="form-group row">
                                        <label className="col-sm-5 form-control-label" htmlFor="input-small">Small
                                            Input</label>
                                        <div className="col-sm-6">
                                            <input type="text" id="input-small" name="input-small"
                                                   className="form-control input-sm" placeholder=".input-sm"/>
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        <label className="col-sm-5 form-control-label" htmlFor="input-normal">Normal
                                            Input</label>
                                        <div className="col-sm-6">
                                            <input type="text" id="input-normal" name="input-normal"
                                                   className="form-control" placeholder="Normal"/>
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        <label className="col-sm-5 form-control-label" htmlFor="input-large">Large
                                            Input</label>
                                        <div className="col-sm-6">
                                            <input type="text" id="input-large" name="input-large"
                                                   className="form-control input-lg" placeholder=".input-lg"/>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div className="row">
                        ...
                        <div className="card">
                            ...
                            <div className="card-block">
                                <div className="form-group has-success">
                                    <label className="form-form-control-label" htmlFor="inputSuccess1">Input with
                                        success</label>
                                    <input type="text" className="form-control" id="inputSuccess1"/>
                                </div>
                                <div className="form-group has-warning">
                                    <label className="form-form-control-label" htmlFor="inputWarning1">Input with
                                        warning</label>
                                    <input type="text" className="form-control" id="inputWarning1"/>
                                </div>
                                <div className="form-group has-danger">
                                    <label className="form-form-control-label" htmlFor="inputError1">Input with
                                        error</label>
                    ...
                    <div className="col-sm-6">
                        <div className="card">
                            ...
                            <div className="card-block">
                                <div className="form-group has-success">
                                    <label className="form-form-control-label" htmlFor="inputSuccess2">Input with
                                        success</label>
                                    <input type="text" className="form-control form-control-success"
                                           id="inputSuccess2"/>
                                </div>
                                <div className="form-group has-warning">
                                    <label className="form-form-control-label" htmlFor="inputWarning2">Input with
                                        warning</label>
                                    <input type="text" className="form-control form-control-warning"
                                           id="inputWarning2"/>
                                </div>
                                <div className="form-group has-danger has-feedback">
                                    <label className="form-form-control-label" htmlFor="inputError2">Input with
                                        error</label>
                                ...
                                <form className="form-horizontal">
                                        ...
                                        <div className="col-md-12">
                                            <div className="input-group">
                                                <div className="input-group-btn">
                                                    <ButtonDropdown isOpen={this.state.first} toggle={() => {
                                        ...
                                        <div className="col-md-12">
                                            <div className="input-group">
                                                <input type="email" id="input2-group3" name="input2-group3"
                                                       className="form-control" placeholder="Email"/>
                                                <div className="input-group-btn">
                                                    <ButtonDropdown isOpen={this.state.second} toggle={() => {
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="input-group">
                                                <div className="input-group-btn">
                                                    <ButtonDropdown isOpen={this.state.third} toggle={() => {
                                    ...
                                    <div className="form-group">
                                        <div className="input-group">
                                            ...
                                            <input type="password" id="password3" name="password3"
                                                   className="form-control"/>
                                            <span className="input-group-addon"><i
                                                className="fa fa-asterisk"></i></span>
                                        </div>
                                    </div>
                        ...
                        <div className="card">
                            ...
                            <div className="card-block">
                                <form action="" method="post">
                                    <div className="form-group">
                                        <div className="input-group">
                                            <input type="text" id="username2" name="username2" className="form-control"
                                    ...
                                    <div className="form-group">
                                        <div className="input-group">
                                            <input type="email" id="email2" name="email2" className="form-control"
                                                   placeholder="Email"/>
                                            <span className="input-group-addon"><i
                                                className="fa fa-envelope"></i></span>
                                        </div>
                        ...
                        <div className="card">
                            ...
                            <div className="card-block">
                                <form className="form-2orizontal">
                                    <div className="form-group">
                                        <label className="form-control-label" htmlFor="prependedInput">Prepended
                                            text</label>
                                        <div className="controls">
                                            <div className="input-prepend input-group">
                                                <span className="input-group-addon">@</span>
                                                <input id="prependedInput" className="form-control" size="16"
                                                       type="text"/>
                                            </div>
                                    ...
                                    <div className="form-group">
                                        <label className="form-control-label" htmlFor="appendedInput">Appended
                                            text</label>
                                        <div className="controls">
                                            <div className="input-group">
                                                <input id="appendedInput" className="form-control" size="16"
                                                       type="text"/><span className="input-group-addon">.00</span>
                                            </div>
                                            <span className="help-block">Here's more help text</span>
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label className="form-control-label" htmlFor="appendedPrependedInput">Append
                                            and prepend</label>
                                        <div className="controls">
                                            <div className="input-prepend input-group">
                                                <span className="input-group-addon">$</span>
                                                <input id="appendedPrependedInput" className="form-control" size="16"
                                                       type="text"/><span className="input-group-addon">.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        <label className="form-control-label" htmlFor="appendedInputButton">Append with
                                            button</label>
                                        <div className="controls">
                                            <div className="input-group">
                                                <input id="appendedInputButton" className="form-control" size="16"
                                                       type="text"/>
                                    ...
                                    <div className="form-group">
                                        <label className="form-control-label" htmlFor="appendedInputButtons">Two-button
                                            append</label>
                                        <div className="controls">
                                            <div className="input-group">
                                                <input id="appendedInputButtons" size="16" className="form-control"
                                                       type="text"/>
                                                <span className="input-group-btn">
