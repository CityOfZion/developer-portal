                    ...
                    {this.state.emailSent ? 'An email has been sent to your email address, please check your inbox' :
                      <div>
                        ...
                        <div className="input-group mb-3">
                          ...
                          <input type="text" id="user" className="form-control" placeholder="Email" autoComplete="off"
                                 onChange={e => this.setState({email: e.currentTarget.value})}/>
                        </div>
                        <div className="row">
                          <div className="col-6">
                            <button type="button" className="btn btn-primary px-4" onClick={e => this.sendEmail()}>Send
                              reset URL
                            </button>
                          </div>
                        </div>
