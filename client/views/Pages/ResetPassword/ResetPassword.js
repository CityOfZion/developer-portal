    ...
    render() {
        ...
        return (
            <div className="app flex-row align-items-center">
                                    ...
                                    <div className="card-block">
                                        ...
                                        <div>
                                            ...
                                            <div className="invalid-feedback">
                                                {
                                                    this.state.passwordErrors.map((error, index) => <p
                                                        key={index}>{error}</p>)
                                                }
                                            </div>
                                            ...
                                            <button type="button" className="btn btn-block btn-success"
                                                    onClick={() => this.resetPassword()}>Confirm
                                            </button>
                ...
                <ErrorModal opened={this.state.passwordResetError} type="warning"
                            message={this.state.passwordResetErrorMessage} title="Error" disableCancel={true}
                            confirmMessage="Close"
                            callback={() => this.setState({passwordResetError: false, passwordResetErrorMessage: ''})}/>
                <ErrorModal opened={this.state.passwordResetSuccess} type="success"
                            message="Your password has been reset, when you close this message you will be redirected"
                            title="Success" disableCancel={true} callback={() => this.props.history.push('/login')}/>
            </div>
        );
    }
}
