...
class AdminReportsOverview extends Component {
    ...
    render() {
        ...
        if (!this.props.reportSummaries) return <div
            ...
            return (
                <tr key={summary._id}>
                    ...
                    <td>
                        ...
                        {this.editButtonEnabled(summary) ? <button className="btn btn-sm btn-success"
                                                                   onClick={e => history.push('/council/reports/edit/' + summary._id)}>
                            <i className="fa fa-pencil"> </i> Edit</button> : ''}
                        <button className="btn btn-sm btn-primary"
                                onClick={e => history.push('/council/reports/view/' + summary._id)}><i
